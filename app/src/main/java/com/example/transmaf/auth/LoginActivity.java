...
public class LoginActivity extends AppCompatActivity {
    ...
    private SessionManager sessionManager; // <-- GANTI SharedPreferences JADI INI
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(this); // <-- INISIALISASI

        // 🟢 AUTO SKIP LOGIN KALAU SUDAH LOGIN
            ...
            public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (res.isStatus()) {
                        ...
                        sessionManager.saveLoginSession(res.getToken(), res.getUser());
